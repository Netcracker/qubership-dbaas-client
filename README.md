[![Maven build](https://github.com/Netcracker/qubership-dbaas-client/actions/workflows/maven-deploy.yml/badge.svg)](https://github.com/Netcracker/qubership-dbaas-client/actions/workflows/maven-deploy.yml)
